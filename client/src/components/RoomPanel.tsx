...
import { PartyActions, PartySendForm, usePartySend, type PartySectionProps } from './PartySection'
 ...
 */
function PlayerRow({ player, member, party, sendOpen, sendFormId, onToggleSend, moreOpen, onToggleMore, onCloseMore, ...admin }: PlayerRowProps) {
  const more = useMore(player, onCloseMore)
      ...
      <div className="lb-field lb-player">
        ...
        <div className="lb-player__line lb-player__line--acoes">
          {member !== undefined && party !== undefined && token !== null && (
            <PartyActions member={member} party={party} sendOpen={sendOpen} sendFormId={sendFormId} onToggleSend={onToggleSend} />
          )}
