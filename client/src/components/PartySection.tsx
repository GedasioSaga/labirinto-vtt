...
import { PARTY_CENTER_LABEL, partyPresenceLabel, type PartyDestination, type PartyItemAction, type PartyMember } from '../lib/party'
    ...
    <section className="lb-party" aria-labelledby={headingId}>
      ...
      {sending !== undefined && sending.token !== null && (
        <div id={formId}>
          ...
          <SendForm key={sending.playerId} member={sending} destinations={sendDestinationsFor(sending, destinations)} onSend={onSend} onClose={closeForm} />
        </div>
      )}
