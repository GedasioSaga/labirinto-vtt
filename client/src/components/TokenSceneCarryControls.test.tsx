...
import { CARRY_FAILED, CARRY_OWNED_HINT, CARRY_TO_LABEL, TokenSceneCarryControls } from './TokenSceneCarryControls'
...
describe('TokenSceneCarryControls', () => {
  ...
  function render(props: { owned?: boolean; destinations?: PartyDestination[]; onCarry?: (sceneId: string, pinId: string | null) => boolean }): void {
    act(() =>
      root.render(<TokenSceneCarryControls tokenName="Zumbi" owned={props.owned ?? false} destinations={props.destinations ?? DESTINOS} onCarry={props.onCarry ?? (() => true)} />),
    )
  }
