...
interface MapStoreState {
   ...
   */
  updateToken: (id: string, patch: Partial<Pick<Token, 'rotation' | 'locked' | 'hidden' | 'color' | 'size' | 'publicName'>>) => void
  ...
  updatePin: (
    id: string,
    patch: Partial<Pick<MapData['pins'][number], 'kind' | 'icon' | 'description' | 'nome' | 'image' | 'locked' | 'destino' | 'passagem' | 'rotulo' | 'saidas' | 'marco' | 'lerDePerto'>>,
  ) => void
