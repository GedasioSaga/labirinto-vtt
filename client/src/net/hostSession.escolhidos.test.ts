...
describe('sceneNote para escolhidos', () => {
  ...
  it('o pacote de quem recebe não diz quem mais leu, nem nome ou id de cena', () => {
    ...
    // Formato exato: nenhum campo além de tipo, id do recado e texto (nem lista de quem recebe).
    for (const o of r.outbound) expect(o.msg).toEqual({ type: 'scene.note', id: expect.any(String), text: 'segredo' })
