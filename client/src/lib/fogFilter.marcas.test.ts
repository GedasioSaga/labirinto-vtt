...
describe('fogFilter: bilhete no lugar', () => {
  ...
  it('quem passar depois vê: longe dela não recebe; no explorado, só a marca que ele JÁ VIU', () => {
    ...
    const view = filterMapForPlayer(map, 'bruno', POSSE, RAIO, explorado, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, new Set(['b1']))
  ...
  it('marca cravada DEPOIS que ele saiu dali não aparece no escuro lembrado: seria a posição de quem a deixou agora', () => {
    ...
    const explorado = createExploration({ width: 60 * 40, height: 60 * 40, grid: 40 })
    markRings(explorado, [[{ x: 100, y: 100 }, { x: 400, y: 100 }, { x: 400, y: 300 }, { x: 100, y: 300 }]], [])
    const semVer = filterMapForPlayer(map, 'bruno', POSSE, RAIO, explorado, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, new Set())
  ...
  it('marca já vista, mas fora do explorado e da visão: não sai (ver uma vez não dá o mapa)', () => {
    const map = corredor([bilhete('b1', 260, 200)])
    expect((filterMapForPlayer(map, 'bruno', POSSE, RAIO, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, new Set(['b1'])).map.marcas ?? []).map((m) => m.id)).toEqual([])
  })
