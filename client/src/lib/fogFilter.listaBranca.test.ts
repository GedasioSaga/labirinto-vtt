 ...
 */
const CAMPOS_DO_JOGADOR = new Set(['id', 'characterId', 'name', 'x', 'y', 'size', 'image', 'imageData', 'rotation', 'color', 'conditions', 'health', 'alerta', 'secret', 'mochila', 'emprestada', 'locked', 'piso'])
