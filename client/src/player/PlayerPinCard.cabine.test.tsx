...
describe('PlayerPinCard: cabine de transporte', () => {
  ...
  it('cabine longe: diz que não está aqui e não oferece passar', () => {
    act(() => root.render(<PlayerPinCard pin={parada({ cabine: 'longe', passagem: 'livre' })} onClose={vi.fn()} onRequestTravel={vi.fn()} />))
  ...
  it('cabine aqui: diz que está aqui e o botão de passar é o do modo do pino', () => {
    const pedir = vi.fn()
    act(() => root.render(<PlayerPinCard pin={parada({ cabine: 'aqui', passagem: 'livre' })} onClose={vi.fn()} onRequestTravel={pedir} />))
  ...
  it('pino de viagem sem cabine: o cartão de sempre, sem frase de cabine', () => {
    act(() => root.render(<PlayerPinCard pin={parada({})} onClose={vi.fn()} onRequestTravel={vi.fn()} />))
