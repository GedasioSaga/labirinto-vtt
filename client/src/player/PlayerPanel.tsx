...
/** Mesma largura do `@media (max-width: 699px)` do player.css: abaixo dela o painel é gaveta. */
const DRAWER_MEDIA_QUERY = '(max-width: 699px)'

/** Gaveta fechada esconde o painel inteiro: o Caderno só está À VISTA com ela aberta. */
...
export function PlayerPanel({
  ...
  // Caderno à vista = lido. No desktop o painel está sempre na tela; no
  // celular, só com a gaveta aberta. Recado que chega com o Caderno aberto já nasce lido.
  useEffect(() => {
    if (tab !== 'caderno' || !notebookUnread) return
    if (!open && isDrawerLayout()) return
    onReadNotebook()
